...
<body>
            ...
            <div class="col">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Mokken</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container-fluid">
          ...
          <div class="row">
              <?php
              $query = $db->query("SELECT * FROM stockItems WHERE StockItemID IN(SELECT StockItemID FROM stockitemstockgroups WHERE StockGroupID = 3) ORDER BY StockItemID");
              if($query->num_rows > 0){
