...
// Dit zou de gegevens moeten ophalen van klaten tabel
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
                    <ul class="navbar-nav mt-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <!-- Button voor het openen van de login en registratie modal -->
                        <li class="nav-item">
                            <form class="form-inline my-2 my-lg-0">
            ...
            <div class="containerorder">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        if ($cart->total_items() > 0) {
                            //Haalt de producten op die in winkelwagen zitten en laat ze zien op een order pagina
                ...
                <!-- Invul formulier voor bezorgades -->
                <div class="shipAddr">
